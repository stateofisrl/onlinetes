...
def root_view(request):
    # Serve Tesla-themed homepage instead of redirecting to login
    return homepage(request)

urlpatterns = [
    # Tesla site routes take precedence
    path('', include(('main.urls', 'main'), namespace='main')),
    path('admin/', admin.site.urls),
    # Frontend template routes (investment platform)
    path('home/', root_view, name='home-legacy'),
